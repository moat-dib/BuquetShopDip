    ...
    <footer>
      <div className="footer__container">
          ...
          <div className="footer__contact__container">
            ...
            <ul className="footer__contacts">
              <li className="footer__contact">
                <LocalPhoneIcon /> <span>+7927874ХХХХ</span>
              </li>
              <li className="footer__contact">
                <EmailIcon /> <span>juju@yandex.cru</span>
              </li>
              <li className="footer__contact">
                <LocationOnIcon /> <span>Йошкар-Ола, РФ</span>
              </li>
            </ul>
          </div>
        ...
        <div className="fotter__copyright__container">
          <ul className="nav">
            <li className="footer__copyright">©2026 JuJuGifts |</li>
