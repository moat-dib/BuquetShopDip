      ...
      <div className="register__card">
        ...
        <div className="register__other__actions">
          <div className="register__login__account">
            Уже есть аккаунт? <Link to="/account/login">Войти</Link>
          </div>
        </div>
      </div>
    </div>
